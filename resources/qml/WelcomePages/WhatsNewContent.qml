...
//
// This component contains the content for the "What's new in Cura IE" page of the welcome on-boarding process.
//
Item
{
    ...
    Label
    {
        ...
        text: catalog.i18nc("@label", "What's new in Cura (IE)")
